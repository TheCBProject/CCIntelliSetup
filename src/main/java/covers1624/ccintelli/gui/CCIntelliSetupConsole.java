...
public class CCIntelliSetupConsole extends javax.swing.JFrame {
    ...
    public void print(final String appendText) {
        SwingUtilities.invokeLater(new Runnable() {
        public void run() {
            synchronized (this) {
    ...
    private void initComponents() {
        ...
        consoleTextPane.setText("Test Text");
        ...
        buttonPaneLayout.setHorizontalGroup(buttonPaneLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(GroupLayout.Alignment.TRAILING, buttonPaneLayout.createSequentialGroup()
                .addContainerGap(362, Short.MAX_VALUE)
                .addComponent(closeButton)
                .addContainerGap())
        );
        buttonPaneLayout.setVerticalGroup(buttonPaneLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        statusPanelLayout.setVerticalGroup(statusPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(statusPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(statusLabel, GroupLayout.DEFAULT_SIZE, 18, Short.MAX_VALUE))
        );
